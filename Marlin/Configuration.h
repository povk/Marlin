...
#define STRING_CONFIG_H_AUTHOR "povk" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "povk Ender3"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "6be25c56-f579-4ef4-a0d7-b25cd37883c2"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Ki_LIST {   2.89,   2.89 }
    #define DEFAULT_Kd_LIST {  95.84,  95.84 }
  #else
    #define DEFAULT_Kp   33.29
    #define DEFAULT_Ki   2.89
    #define DEFAULT_Kd   95.84
  #endif
#endif // PIDTEMP
